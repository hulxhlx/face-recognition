...
def train(arglearning_rate, epoch_size, sess, epoch, image_list, label_list, index_dequeue_op, enqueue_op,
...
with tf.Graph().as_default():
	...
	with sess.as_default():
		...
		for epoch in range(1, max_nrof_epochs + 1):
			...
			# Train for one epoch
			t = time.time()
			cont = train(arglearning_rate, epoch_size, sess, epoch, image_list, label_list, index_dequeue_op,
