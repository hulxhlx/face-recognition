...
def read_data_sets(data_dir,
  ...
  file_list, label_list = facenet.get_image_paths_and_labels(train_set)
  image_list=[]
  for i in file_list:
    image = cv2.imread(i)
    image_list.append(image)
  valimage_list, val_setlabel_list = facenet.get_image_paths_and_labels(train_set)


  train = _DataSet(image_list, label_list)
  test = _DataSet(valimage_list, val_setlabel_list)
