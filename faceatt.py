...
def train(image_batch, arglearning_rate, epoch_size, sess, epoch, image_list, label_list, index_dequeue_op, enqueue_op,
	...
	while batch_number < epoch_size:
		...
		# print(sess.run(batch_size,feed_dict=feed_dict))
...
#good
	...
	with sess.as_default():
		...
		for epoch in range(1, max_nrof_epochs + 1):
			...
			# Train for one epoch
			t = time.time()
			cont = train(image_batch,arglearning_rate, epoch_size, sess, epoch, image_list, label_list, index_dequeue_op,
